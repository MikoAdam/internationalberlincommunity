...
const TestimonialsAvatars = ({ priority = false }) => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-3">
      ...
      {/* RATING */}
      <div className="flex flex-col justify-center items-center md:items-start gap-1 text-center md:text-left">
        <div className="rating flex !justify-center md:!justify-start">
          {[...Array(5)].map((_, i) => (
            <svg
