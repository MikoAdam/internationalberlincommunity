...
const Testimonial1Small = () => {
  return (
    <section className="bg-base-200"> {/* Changed bg-base-100 to bg-base-200 */}
      <div className="space-y-6 md:space-y-8 max-w-lg mx-auto px-8 py-16 md:py-32 ">
        ...
        <div className="text-base leading-relaxed space-y-2 max-w-md mx-auto text-center">
          <p>
            <span className="bg-warning/25 px-1.5">
              IBC has been a fantastic way to meet new people and learn about different cultures.
            </span>{" "}
            I highly recommend joining their events!"
          </p>
        </div>
        <div className="flex justify-center items-center gap-3 md:gap-4">
          ...
          />
          <div>
            <p className="font-semibold">Jane T. S.</p>
            <p className="text-base-content/80 text-sm">Member since April 2024</p>
          </div>
        </div>
      </div>
    </section>
