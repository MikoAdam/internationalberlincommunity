        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-8 mb-12">
            ...
            <div className="lg:w-2/3">
              ...
              {/* Certifications */}
              <section className="bg-base-200 rounded-2xl p-8 shadow-lg">
                <h2 className="text-2xl font-bold text-base-content mb-6 border-b border-base-300 pb-3">
                  Certifications
                </h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-base-content">AWS Generative AI Applications Specialization</h3>
                      <p className="text-sm text-base-content/60">Amazon Web Services (AWS) · Issued Jul 2025</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-secondary/10 rounded-lg flex items-center justify-center flex-shrink-0">
                      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" className="w-6 h-6 text-secondary">
                        <path fill="currentColor" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10s10-4.48 10-10S17.52 2 12 2m-2 15l-5-5l1.41-1.41L10 14.17l7.59-7.59L19 8z"/>
                      </svg>
                    </div>
                    <div>
                      <h3 className="font-semibold text-base-content">Generative AI Leader</h3>
                      <p className="text-sm text-base-content/60">Google Cloud Training · Issued Jun 2025</p>
                    </div>
                  </div>
                </div>
              </section>
