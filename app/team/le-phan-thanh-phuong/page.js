                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-primary pl-6">
                    <h3 className="text-xl font-semibold text-base-content mb-2">
                      {t('studentRA', language)}
                    </h3>
                    <p className="text-primary font-medium mb-2">
                      Université de Montréal · {t('internship', language)}
                    </p>
                    <p className="text-base-content/70 mb-2">Jun 2023 – {t('present', language)} · Montreal, Canada · Hybrid</p>
                  ...
                  <div className="border-l-4 border-secondary pl-6">
                    ...
                    <p className="text-secondary font-medium mb-2">
                      University of Pécs Medical School (POTE formerly) · {t('internship', language)}
                    </p>
                  ...
                  <div className="border-l-4 border-accent pl-6">
                    <h3 className="text-xl font-semibold text-base-content mb-2">
                      {t('soundDesigner', language)}
                    </h3>
                    <p className="text-accent font-medium mb-2">
                      {t('freelance', language)} · Mar 2019 – Jul 2019
                    </p>
                    <p className="text-base-content/80">
                      {t('soundDesc', language)}
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section className="bg-base-100 rounded-2xl p-8 shadow-soft mb-8">
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-primary pl-6">
                    ...
                    <p className="text-primary font-medium mb-2">University of Potsdam · Oct 2022 – {t('present', language)}</p>
                  </div>
